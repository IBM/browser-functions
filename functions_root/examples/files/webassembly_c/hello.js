...
function _jobCompleted(ptr,len){ let uint8Array = new Uint8Array(HEAPU8.subarray(ptr, ptr + len)); jobCompleted(new TextDecoder("utf-8").decode(uint8Array)) }



// STATICTOP = STATIC_BASE + 3120;
...
Module["asm"] = asm;
var ___em_js__jobCompleted = Module["___em_js__jobCompleted"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["___em_js__jobCompleted"].apply(null, arguments)
};
